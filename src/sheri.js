...
const request = async function(url) {
	return new Promise((resolve, reject) => {
		if (!APIKey) {
			return reject(new Error('APIKey is required for using this private API.'));
		}
...
const METHODS = {
	...
	NSFW: [
		...
		{ name: 'brony', prefix: 'n' },
		{ name: 'bulge', prefix: 'n' },
		{ name: 'comics', prefix: 'n' },
		{ name: 'cuddle', prefix: 'n' },
		{ name: 'femboy', prefix: 'n' },
		{ name: 'futa', prefix: 'n' },
		{ name: 'group', prefix: 'n' },
		{ name: 'hold', prefix: 'n' },
		{ name: 'hug', prefix: 'n' },
		{ name: 'kiss', prefix: 'n' },
		{ name: 'lick', prefix: 'n' },
		{ name: 'pokemon', prefix: 'n' },
		{ name: 'seduce', prefix: 'n' },
		{ name: 'solo', prefix: 'n' },
		{ name: 'tease', prefix: 'n' },
		{ name: 'trap', prefix: 'n' },
		'pussy',
